...
void HelperFunctions::getKeysFromSuccessor(NODE_INFO &nodeInfo,string ip,int port){
    struct sockaddr_in serverToConnectTo;
    socklen_t l = sizeof(serverToConnectTo);
...
void HelperFunctions::storeAllKeys(NODE_INFO &nodeInfo,string keysAndValues){
...
void HelperFunctions::sendNeccessaryKeys(NODE_INFO &nodeInfo,int newSock,struct sockaddr_in client,string nodeIdString){
...
/* */
void HelperFunctions::sendValToNode(NODE_INFO nodeInfo,int newSock,struct sockaddr_in client,string nodeIdString){
...
void HelperFunctions::sendSuccessor(NODE_INFO nodeInfo,string nodeIdString,int newSock,struct sockaddr_in client){
